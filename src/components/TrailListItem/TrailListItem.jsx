...
export default function TrailListItem({ trailItem }) {
  return (
    <div className="relative flex w-full max-w-[22rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-xl ">
      <div className="relative mx-6 mt-6 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40">
        <img
          src={trailItem.image}
      ...
      <div className="p-6">
        ...
        <p className="block font-sans text-base font-light leading-relaxed text-gray-700 antialiased">{trailItem.description}</p>
