    ...
    <div className="relative flex w-full max-w-[22rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-xl ">
      ...
      <div className="p-4 flex flex-col">
        <div className="mb-2">
          ...
          <p className="font-sans text-base font-normal leading-relaxed text-blue-gray-900 antialiased">
        ...
        <p className="flex-grow font-sans text-base font-light leading-relaxed text-gray-700 antialiased overflow-ellipsis">
